...
window.onload = function() {
	...
	/* 
	This function sorts data, completes the scalers draws x and y axis of the bar chart with the right text, 
	draws bars and makes the bars interactive by changing color and displaying the value on mouse hover. 
	*/
